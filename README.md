...
- Low-quality OCR triggers a secondary pass and/or Vision fallback pass. Control with `OCR_MULTI_PASS=0`, `OCR_QUALITY_FALLBACK=0`, and `OCR_QUALITY_THRESHOLD=0.62`.
